...
from midagri_comercio_exterior.storage.delta import DELTA_RUNTIME_LOCK, get_delta_runtime
    ...
    with CONTROL_STATE_LOCK, _get_lock("control_events"):
        ...
        if not settings.is_minio:
            try:
                ...
                logger.exception("No se pudo sincronizar el journal de eventos MIDAGRI local; se conserva en cache local.")
